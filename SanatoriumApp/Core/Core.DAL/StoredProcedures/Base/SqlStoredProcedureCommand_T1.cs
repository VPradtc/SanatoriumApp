...
{
    public abstract class SqlStoredProcedureCommand<TArgs> : SqlStoredProcedure<TArgs, int>
    {
        public SqlStoredProcedureCommand(IConnectionFactory connectionFactory, IDbCommandInvoker commandInvoker) 
            : base(connectionFactory, commandInvoker)
        {
        }
